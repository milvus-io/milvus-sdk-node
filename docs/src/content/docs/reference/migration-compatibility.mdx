...
| Advanced StructArray           | Struct child schemas, nullable rows, dynamic nullable fields, child-field indexes, `element_filter`, element-level query/search/iterator offsets                                                                              | [Data Types & Schemas](../core-concepts/data-types-schemas#structarray), [Query & Search](../operations/data-operations-query#structarray-element-filters)         |
| Query aggregation              | `group_by_fields`, aggregation expressions `count`, `min`, `max`, `sum`, and `avg` in `output_fields`                                                                                                                         | [Query & Search](../operations/data-operations-query#query-aggregation), [Data Operations](../api-reference/data#query-aggregation)                                |
| Search aggregation             | `search_aggregation`, bucket metrics, ordering, top hits, nested aggregation, typed `agg_buckets`                                                                                                                             | [Query & Search](../operations/data-operations-query#search-aggregation), [Data Operations](../api-reference/data#search-aggregation)                              |
...
| Schema and function management | `addCollectionField()`, `addCollectionFields()`, `dropCollectionField()`, `alterCollectionSchema()`, `addFunctionField()`, `dropFunctionField()`                                                                              | [Collection Management](../management/collection-management#dynamic-schema), [Collection Operations](../api-reference/collections#schema-mutation)                 |
