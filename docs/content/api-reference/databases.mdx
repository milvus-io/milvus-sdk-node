...
Database APIs manage Milvus databases and database-level properties. Most collection and data APIs accept `db_name`; you can also set the active database with [`client.use`](/api-reference/client#use).
...
- [Database Operations guide](/operations/database-operations)
- [User & Role Operations](/api-reference/users-roles)
